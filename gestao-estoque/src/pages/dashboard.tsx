...
export const Dashboard: React.FC = () => {
  ...
  const produtosPertoVencimento = produtos.filter((item) => {
    ...
    // O validade vem como YYYY-MM-DD
    const dataValidade = new Date(item.validade + 'T00:00:00');
    const diffTime = dataValidade.getTime() - hojeDate.getTime();
  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6">
      ...
      {produtosPertoVencimento.length > 0 && (
        <div className="bg-white border border-[#c7c4d8]/40 rounded-2xl p-4 md:p-6 shadow-sm mt-4 md:mt-6">
          <div className="flex justify-between items-center mb-4 md:mb-6">
